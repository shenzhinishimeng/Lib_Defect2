...
import com.catail.bimax_defect2.f_defect2.adapter.Defect2StatisticsStatusHomeAdapter;
...
public class Defect2StatisticsStatusPieChartFragment extends BaseVisibleInitFragment {
    private List<QueryDefect2StatisticsStatusPieChartListsResult.ResultBean> mDataList;
    private Defect2StatisticsStatusHomeAdapter rvListAdapter;
    ...
    public void initView(View view) {
        ...
        rvListAdapter = new Defect2StatisticsStatusHomeAdapter(R.layout.adapter_inspection_statistics_home_item, mDataList);
...
//        String projectName = getArguments().getString("projectName");
    ...
    private void initPieChartTitle() {
        if (status.equals("0")) {
            tv_statistic_title.setText(getResources().getString(R.string.defect2_statistics_title_0));
        } else if (status.equals("3")) {
            tv_statistic_title.setText(getResources().getString(R.string.defect2_statistics_title_3));
        } else if (status.equals("4")) {
            tv_statistic_title.setText(getResources().getString(R.string.defect2_statistics_title_4));
        } else if (status.equals("5")) {
            tv_statistic_title.setText(getResources().getString(R.string.defect2_statistics_title_5));
        } else if (status.equals("6")) {
            tv_statistic_title.setText(getResources().getString(R.string.defect2_statistics_title_6));
        }
    }

    @SuppressLint({"NotifyDataSetChanged", "SetTextI18n"})
    private void showStatusPieChartUI(List<QueryDefect2StatisticsStatusPieChartListsResult.ResultBean> result) {
        ...
        for (int i = 0; i < mDataList.size(); i++) {
            typeNameLists.add(mDataList.get(i).getName());
            if (totalCnt > 0) {
                    ...
                    .execute(new Callback() {
                        ...
                        public Object parseNetworkResponse(Response response, int id) throws Exception {
                            ...
                            return GsonUtil.GsonToBean(replace,
                                    QueryDefect2StatisticsStatusPieChartListsResult.class);
                        }
                        ...
                        public void onResponse(Object response, int id) {
                            try {
                                QueryDefect2StatisticsStatusPieChartListsResult resultBean
                                        = (QueryDefect2StatisticsStatusPieChartListsResult) response;
